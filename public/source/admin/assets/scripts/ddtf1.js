...
$.fn.ddTableFilter = function(options) {
  ...
  return this.each(function() {
    ...
    $('#th_format ', table).each(function(index) {
      ...
      var col = $('tr:not(.skip-filter) td:nth-child(' + (index + 7) + ')', table).each(function() {
      ...
      $('#th_format1 ', table).each(function(index) {
          if($(this).hasClass('skip-filter')) return;
          var selectbox = $('<select class="" style="width:auto">');
          var values = [];
          var opts = [];
          ...
          var col = $('tr:not(.skip-filter) td:nth-child(' + (index + 6) + ')', table).each(function() {
              var cellVal = options.valueCallback.apply(this);
              if(cellVal.length == 0) {
                  cellVal = '--empty--';
              }
