{{-- <script type="text/javascript" src="{{ asset('source/admin/assets/vendor/jquery/jquery.min.js') }}"></script> --}}
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/vendor/jquery/jquery.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/scripts/search.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/scripts/ddtf.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('source/admin/assets/scripts/isotope.pkgd.min.js') }}"></script>
