				...
				<nav>	
					@if (Session::has('key'))
						...
						<ul class="nav">
							...
							<li>
								<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-laptop"></i> <span>Quản lý đơn hàng</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
