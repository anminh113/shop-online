                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="order_total_content ">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="order_cart_title order_cart_title_text">32-34 đường số 3 - khu TĐC
                                            - ĐHYD, KV4 - P.An khánh - Q.Ninh kiều</div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="order_cart_title order_cart_title_text">Phường An Khánh, Quận Ninh
                                            Kiều, Cần Thơ</div>
                                    </div>
                                    <div class="col-lg-12">
                            ...
                            <div class="order_total_content ">
                                <div class="row">
                                    <div class="col-lg-7 col-md-6">
                                        <div class="order_cart_title ">Tạm tính ({{Session('cart')->totalQty}} sản
                                            phẩm)</div>
                                    </div>
                            ...
                            <div class="order_total_content ">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="button cart_button_checkout" onclick="window.location='check-out';">Thanh
                                            Toán</div>
                                    </div>
                                </div>
                            </div>
