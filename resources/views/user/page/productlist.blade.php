                                ...
                                @foreach ($data['products'] as $item )
                                    ...
                                    <div class="product_item ">
                                        ...
                                        <div class="product_content">
                                            <div class="product_price" style="font-size: 16px">{{$item['price']}} VND</div>
                                        ...
                                        <a href="{{route('gio-hang',$item['productId'])}}" class="btn btn-outline-info btn-change" style="font-size: 12px; bottom: 2px">Add to Cart</a>
                                    </div>
                                @endforeach
